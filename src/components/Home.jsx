  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white px-6 py-16">
      <motion.h1
        ...
        className="text-4xl sm:text-5xl font-extrabold text-blue-600 mb-6 text-center"
      >
      ...
      <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 max-w-6xl mx-auto">
        {allServices.map((service) => (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition text-left cursor-pointer"
          >
      ...
      <div className="mt-12 text-center">
        <Link
          to="/signup"
          className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-full shadow-lg transition"
        >
          Get Started
        </Link>
      </div>
