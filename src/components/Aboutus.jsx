    ...
    <section className="bg-gray-50 py-16 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="bg-white p-8 rounded-2xl shadow-xl mb-20"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-20">
          {team.map((member, idx) => (
            <motion.div
              key={idx}
              initial={{ opacity: 0, y: 20 }}
              ...
              whileHover={{ y: -5 }}
              className="bg-white p-6 rounded-xl shadow-md text-center transform transition duration-300 hover:shadow-xl hover:shadow-blue-100"
            >
              <div className="overflow-hidden w-24 h-24 rounded-full mx-auto mb-4">
                <img
                  src={member.img}
        ...
        {/* Testimonials */}
        <h3 className="text-3xl font-semibold text-gray-800 mb-6">What Users Say</h3>
          ...
          {testimonials.map((t, idx) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <img src={t.img} alt={`Photo of ${t.name}`} className="w-12 h-12 rounded-full object-cover" />
